...
export default function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div
      className={`relative bg-white h-screen rounded-[16px] transition-all durationease-in-out duration-500 ${className} ${
    ...
    >
      ...
      <div className="absolute w-full bg-white top-0 flex justify-center items-center shadow-sm  z-50">

        <div className=" max-w-[100px] xl:max-w-[150px] h-[100px] xl:h-[150px] my-[4px] pl-[2px] xl:pl-[13px] px-[2px] xl:pr-[15px] xl:py-10  bg-white flex justify-center items-center">
      ...
      <div className="pt-[150px]  pl-[2px] h-full xl:pl-[13px] flex-1 overflow-auto">
        ...
        <div className="flex flex-col justify-center items-center py-2">
          {/* <button className="absolute -top-[-20px] -right-[-40px]">
            ...
            {/* <div className="w-full absolute bottom-10 xl:bottom-6 bg-white flex justify-start items-center pl-[20px] xl:pl-2  "> */}
            <div className="w-full xl:bottom-6 bg-white flex justify-start items-center pl-[20px] xl:pl-2  ">
              ...
              >
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 19"
                  className={` fill-[#009f4d] hover:fill-[#7da59d]`}
                >
