...
export default function Sidebar({ className }: SidebarProps) {
  ...
  const fetchData2 = useCallback(async () => { // Wrap in useCallback
    try {
      ...
      if (!token) {
        // handleLogout(); // ฟังก์ชันสำหรับเคลียร์ค่าและเด้งไปหน้า Login
        return;
      }
  ...
  return (
    <div
      className={`relative bg-oatmilk shadow-xl h-screen rounded-[16px] transition-all durationease-in-out duration-500 ${className} ${
        hoversidebar ? "w-[120px] xl:w-[200px]" : "w-[64px] xl:w-[100px]"
      }`}
      onMouseEnter={() => {
    ...
    >
      ...
      <div className="pt-[150px]  pl-[2px] h-full xl:pl-[13px] flex-1 overflow-auto">
        ...
        <div className="flex flex-col justify-center items-center py-2">
          {/* <button className="absolute -top-[-20px] -right-[-40px]">
              ...
              <svg
                ...
                className={`${
                  currentPathname === "/backoffice/dashboard"
                    ? "fill-oatmilk"
                    : "fill-oxbowteal hover:fill-deepforest"
                }`}
              >
              ...
              >
                <svg
                  ...
                  className={` ${
                    ...
                    currentPathname === "/backoffice/shop"
                      ? "stroke-oatmilk"
                      : "stroke-oxbowteal hover:stroke-deepforest"
            ...
            {/* Report */}
            {level === "Employee" || level === "Owner" || level === "Manager" || level === "Admin" ? (
              <SubButtomSidebar
                data={[
                  {
                    ...
                    <>
                      <div
                        className="
                          inline-flex
                          absolute 
                          top-[8px] left-[34px] xl:top-[14px] xl:left-[50px] 
                          bg-red-600 
                          shadow-lg
                          rounded-full 
                          animate-ping
            ...
            {/* <div className="w-full absolute bottom-10 xl:bottom-6 bg-oatmilk flex justify-start items-center pl-[20px] xl:pl-2  "> */}
            <div className="w-full xl:bottom-6 bg-oatmilk flex justify-start items-center pl-[20px] xl:pl-2  ">

              <button
                className="flex flex-row hover:bg-hoverteal xl:p-4 rounded-lg"
                onClick={handleLogout}
              >
                {/* <Image width={70} height={70} src="/img/logout.png" alt="logout" /> */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 19"
                  className={` fill-oxbowteal hover:fill-deepforest`}
                >
                ...
                {showLogoutTextWithDelay ? (
                  <p
                    className={`ml-2 xl:ml-4 font-semibold text-[10px] xl:text-sm ${
                      "text-oxbowteal" // Removed 'status' as it's not defined here. Defaulting to the non-active color.
                    }`}
                  >
                    ออกจากระบบ
                  </p>
