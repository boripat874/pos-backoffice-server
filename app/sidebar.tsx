...
export default function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div
      className={` bg-white h-screen pl-[2px] xl:pl-[13px] rounded-[16px] transition-all durationease-in-out duration-500 ${className} ${
        hoversidebar ? "w-[120px] xl:w-[200px]" : "w-[54px] xl:w-[90px]"
      }`}
      onMouseEnter={() => {
